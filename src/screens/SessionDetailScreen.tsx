  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-md mx-auto px-4 py-8 flex flex-col gap-5">
        ...
        {/* Utility actions — deliberately quieter and half-width so they can't
            be mistaken for a primary CTA */}
        {meta.completed_at && (
          <div className="flex gap-2">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-1.5 border border-edge rounded-xl py-2.5 text-xs font-medium text-ink-secondary hover:text-ink hover:border-edge-strong active:opacity-70 transition-colors"
            >
            ...
            <button
              ...
              disabled={reopening}
              className="flex-1 flex items-center justify-center gap-1.5 border border-edge rounded-xl py-2.5 text-xs font-medium text-ink-secondary hover:text-ink hover:border-edge-strong active:opacity-70 transition-colors disabled:opacity-50"
            >
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
